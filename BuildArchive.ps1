...
{
    [System.IO.Compression.ZipFileExtensions]::CreateEntryFromFile($ZipArchive, $File, $File) | Out-Null
}

# add Readme and License files
[System.IO.Compression.ZipFileExtensions]::CreateEntryFromFile($ZipArchive, "LICENSE", $PluginName + "/LICENSE") | Out-Null
[System.IO.Compression.ZipFileExtensions]::CreateEntryFromFile($ZipArchive, "README.md", $PluginName + "/README.md") | Out-Null
